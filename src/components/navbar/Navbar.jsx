        ...
        <nav className="navbar-container">
            ...
            <div className="navbar-links">
                <NavbarLink 
                    condition={theme} 
                    path="/"
                    svg={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-moon-stars" viewBox="0 0 16 16">
                ...
                <NavbarLink 
                    condition={login}
                    path="/login"
                    svg={<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
