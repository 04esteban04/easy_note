...
function Menu ({newNotePopupOpen, handleOptionClick, totalNotes, page, setPage}) {
    ...
    return (
        <aside id="menu" className='d-flex flex-column justify-content-center align-items-center align-items-sm-start w-100 mt-3 mb-3'>
            ...
            <div id='menu-options' 
                className='d-flex flex-wrap justify-content-center align-items-center flex-sm-column align-items-sm-start'>   
                
                <hr className="w-100 my-2" />
                
                <button type='button' onClick={() => newNotePopupOpen(true)} 
                        className="option-button text-light text-decoration-none bg-transparent border-0 my-2 ms-sm-2">
                    Create note
                </button>
                ...
                <button type='button' onClick={() => handleOptionClick('tag')} 
                        className="option-button text-light text-decoration-none bg-transparent border-0 my-2 mb-sm-2 ms-sm-2">
                    Order by tag
                </button>
                ...
                <div className='d-flex align-items-center flex-sm-column flex-wrap'>
